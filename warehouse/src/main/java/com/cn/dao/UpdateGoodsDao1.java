...
public class UpdateGoodsDao1 {//增加goods 数量
	public int updateGoods(Goods goods, Output output)//1:登录成功   0：登录失败（用户名或密码有误）  -1：系统异常    
	{
		...
		try {
			...
			int number=databaseNumber-Integer.parseInt(output.getOutnumber());		
